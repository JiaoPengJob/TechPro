...
public class Hour {
    ...
    public Hour(int id, int school_id, String start_time, String finish_time, int normal_fee, int holiday_fee, int time_length, String created_at, String updated_at) {
        this.id = id;
