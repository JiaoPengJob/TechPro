...
//                    return new MarkingBean("", "0", "开始训练","bencixunliankaishi","");
                ...
                case "qibushichelianghouliujulixiaoyu30limikou10fen":
                    return new MarkingBean("", "10", "起步时后溜小于30公分","qibushichelianghouliujulixiaoyu30limikou10fen","10105");
                case "qibushichelianghouliujulidayu30limikou100fen":
                    return new MarkingBean("","100" ,"起步时后溜大于30公分","qibushichelianghouliujulidayu30limikou100fen","10202");
                case "qibushibushiyonghuocuowushiyongzhuanxiangdengkou10fen":
                    return new MarkingBean("", "10","未按规定使用转向灯","qibushibushiyonghuocuowushiyongzhuanxiangdengkou10fen","10205");
                case "buanguidingluxianxingshikou100fen":
                    return new MarkingBean("", "100","不按规定路线行驶","buanguidingluxianxingshikou100fen","20101");
                case "xihuoyicikou10fen":
                    return new MarkingBean("", "10","熄火一次","xihuoyicikou10fen","10210");
                case "buanguidingshiyonganquandaikou100fen":
                    return new MarkingBean("","100", "未按规定使用安全带","buanguidingshiyonganquandaikou100fen","10101");
                case "chelunyadaolubianyuanxiankou100fen":
                    return new MarkingBean("", "100","车轮压道路边缘线","chelunyadaolubianyuanxiankou100fen","10114");
                ...
                case "cheshenchuxiankou100fen":
                    return new MarkingBean("倒车入库", "100","车身出线","cheshenchuxiankou100fen","20102");
                case "daocheruku":
                    return new MarkingBean("倒车入库",  "0","开始","daocheruku","");
                case "daokuburukou100fen":
                    return new MarkingBean("倒车入库", "100","倒库不入","daokuburukou100fen","20103");
//                case "buanguidingluxianxingshikou100fen":
...
//                    return new MarkingBean("坡道定点停车和起步","不按规定路线行驶","100");
                ...
                case "tingcheweizhibuzhunquewuchadayu50limikou100fen":
                    return new MarkingBean("坡道定点停车和起步", "100","停车位置不准确误差大于50公分","tingcheweizhibuzhunquewuchadayu50limikou100fen","20301");
                case "tingcheweizhibuzhunquewuchaxiaoyu50limikou10fen":
                    return new MarkingBean("坡道定点停车和起步", "10","停车位置不准确误差小于50公分","tingcheweizhibuzhunquewuchaxiaoyu50limikou10fen","20303");
                case "tingchehouchenshenjulilubianyuanxiandayu30limikou10fen":
                    return new MarkingBean("坡道定点停车和起步", "10","车身距路边缘线大于30公分","tingchehouchenshenjulilubianyuanxiandayu30limikou10fen","20304");
                case "qibushishijianchaoguoguidingshijiankou100fen":
                    return new MarkingBean("坡道定点停车和起步","100", "起步时间超过30秒","qibushishijianchaoguoguidingshijiankou100fen","20302");
                case "weianguidingshiyongzhuanxiangdengkou10fen":
                    return new MarkingBean("坡道定点停车和起步",  "10","未按规定使用转向灯","weianguidingshiyongzhuanxiangdengkou10fen","10205");
                 /*------------------侧方停车------------------------*/
                case "chelunyadaolubianyuanxiankou10fen":
                    return new MarkingBean("侧方停车","10", "车轮压道路边缘线","chelunyadaolubianyuanxiankou10fen","20403");
//                case "chelunyadaolubianyuanxiankou100fen":
...
//                    return new MarkingBean("侧方停车","中途停车","100");
                case "rukutingzhihoucheshenchuxiankou100fen":
                    return new MarkingBean("侧方停车", "100","车身出线","rukutingzhihoucheshenchuxiankou100fen","20401");
                case "weianguidingshiyongzhuanxiangdengkou10fenkou10fen":
                    return new MarkingBean("侧方停车", "10","未按规定使用转向灯","weianguidingshiyongzhuanxiangdengkou10fenkou10fen","10206");
                /*--------------------曲线行驶--------------------------*/
//                case "chelunyadaolubianyuanxiankou100fen":
...
//                    return new MarkingBean("曲线行驶","不按规定路线行驶","100");
                ...
                case "jinrushihualuqianweijiansu":
                    return new MarkingBean("模拟湿滑路行驶","100", "进入湿滑路前未减速","jinrushihualuqianweijiansu","21602");
                case "weinengshiyongdidangpingwentongguo":
                    return new MarkingBean("模拟湿滑路行驶", "100","未能使用低速挡平稳通过","weinengshiyongdidangpingwentongguo","21601");
                ...
                case "shidisuidaorukoushiweiminglabadengkou10fen":
                    return new MarkingBean("模拟隧道行驶", "10","驶抵隧道入口时未鸣喇叭","shidisuidaorukoushiweiminglabadengkou10fen","21403");
                case "shidisuidaoshiweijiansuhuoweikaiqiqianzhaoming":
                    return new MarkingBean("模拟隧道行驶", "100","驶抵隧道时未减速或未开启前照灯","shidisuidaoshiweijiansuhuoweikaiqiqianzhaoming","21401");
                case "shirusuidaohoubuanguidingchedaoxingshibiandao":
                    return new MarkingBean("模拟隧道行驶", "100","驶入隧道后不按规定车道行驶、变道","shirusuidaohoubuanguidingchedaoxingshibiandao","21402");
                ...
                case "shidisuidaochukoushiweiminglabadengkou10fen":
                    return new MarkingBean("模拟隧道行驶", "10","驶抵隧道出口时未鸣喇叭灯","shidisuidaochukoushiweiminglabadengkou10fen","21403");
                case "shichusuidaohouweiguanbiqianzhaodengkou10fen":
                    return new MarkingBean("模拟隧道行驶", "10","驶出隧道后未关闭前照灯","shichusuidaohouweiguanbiqianzhaodengkou10fen","21404");
            }
        }
        return null;
    }
